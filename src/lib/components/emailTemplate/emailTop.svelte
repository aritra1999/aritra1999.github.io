...
{#if $page.url.pathname !== '/'}
    {#if $metaStore.screen === 'desktop'}
        <div class="py-4 px-10">
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center">
                    <div class="h-[40px] w-[40px] bg-slate-300 rounded-full flex items-center justify-center mr-6">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="h-5 w-5" width="32" height="32" preserveAspectRatio="xMidYMid meet" viewBox="0 0 256 256"><path fill="currentColor" d="M231.9 212a120.7 120.7 0 0 0-67.1-54.2a72 72 0 1 0-73.6 0A120.7 120.7 0 0 0 24.1 212a8 8 0 1 0 13.8 8a104.1 104.1 0 0 1 180.2 0a8 8 0 1 0 13.8-8ZM72 96a56 56 0 1 1 56 56a56 56 0 0 1-56-56Z"></path></svg>
                    </div>
                    <div class="text-xs">
                        <div>Aritra Mondal - <span class="text-slate-500"> aritra041999@gmail.com </span></div>
                        To Me
                    </div>
                </div>
        ...
        <div class="mx-4 px-2 py-4">
            ...
            <div class="flex items-center mt-2">
                ...
                <div class="text-xs">
                    ...
                    To Me - <span class="text-slate-600 text-xs">Thursday, Nov 19, 3:18 PM</span>
                </div>
            </div>
        </div>
    {/if}
