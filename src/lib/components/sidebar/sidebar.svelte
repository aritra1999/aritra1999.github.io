...
>
  <svg
    ...
    class="h-5 w-5 text-slate-500 mr-4"
    fill="none"
    viewBox="0 0 24 24"
    stroke="currentColor"
    stroke-width="2"
...
<div
  class="h-[calc(100vh-5rem)] bg-white md:bg-transparent px-2 pb-3 w-72 absolute ease-in-out transition-all duration-300 z-30 left-0 top-[5rem] {$metaStore.showSidebar
    ? 'translate-x-0'
