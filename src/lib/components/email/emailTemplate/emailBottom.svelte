<script>
	...
	const options = [
		{
			title: 'Forward',
			icon: '<path stroke-linecap="round" stroke-linejoin="round" d="M15 15l6-6m0 0l-6-6m6 6H9a6 6 0 000 12h3" />'
		},
		{
			title: 'Reply',
...
{#if $page.url.pathname !== '/'}
	<div class="flex justify-between space-x-4 border-t p-4 font-medium sm:justify-end">
