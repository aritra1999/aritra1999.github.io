...
<div class="pb-24 pt-4 lg:px-16 md:px-6 px-2">
  <a href={Resume} target="_blank" rel="noreferrer">
    <div
      class="h-40 w-72 bo bg-gray-100 mt-10 py-3 px-4 rounded-md text-gray-500 flex items-center justify-center cursor-pointer"
    >
      <svg
  ...
  <div class="my-6">
    Problem?
    <a href={Resume} target="_blank" rel="noreferrer" class="ml-2 underline">
      Open here
    </a>
  </div>
</div>
