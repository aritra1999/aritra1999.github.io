...
<div class="page-container">
  <Navbar />
  <div
    class="fixed w-full pr-2 pb-3 ease-in-out transition-all duration-300 {$metaStore.showSidebar &&
    $metaStore.screen === 'desktop'
      ? 'pl-72'
      : 'pl-2'} h-[calc(100vh-5rem)]"
  >
    <div class="bg-white rounded-xl h-full">
      ...
      {/if}
      <div
        class="flex sm:h-[calc(100vh-10rem)] h-[calc(100vh-6rem)] overflow-y-auto overflow-x-hidden w-full border-slate-200"
      >
        <div
